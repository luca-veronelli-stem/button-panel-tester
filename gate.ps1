...
# Phase D focused proof: the button-press-test FSM property suite (7 theorems' mirrors).
dotnet test tests/ButtonPanelTester.Tests/ButtonPanelTester.Tests.fsproj --framework net10.0 -c Release --filter "Category!=Hardware&FullyQualifiedName~ButtonPressTest"
if ($LASTEXITCODE -ne 0) { $failures += 'focused: ButtonPressTest' }
