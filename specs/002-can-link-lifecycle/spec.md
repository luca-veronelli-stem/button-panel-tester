...
**Status**: Implemented — CAN-link lifecycle complete on the four-family FSM (US1 via [#115](https://github.com/luca-veronelli-stem/button-panel-tester/issues/115)/[#122](https://github.com/luca-veronelli-stem/button-panel-tester/pull/122); US3 via [#117](https://github.com/luca-veronelli-stem/button-panel-tester/issues/117); lifecycle fix queue [#124](https://github.com/luca-veronelli-stem/button-panel-tester/issues/124)–[#143](https://github.com/luca-veronelli-stem/button-panel-tester/issues/143) + docs capstone [#154](https://github.com/luca-veronelli-stem/button-panel-tester/issues/154) landed under salvage epic [#159](https://github.com/luca-veronelli-stem/button-panel-tester/issues/159)). Panel-discovery (formerly US2 + FR-007–013) extracted to [`specs/003-panel-discovery/`](../003-panel-discovery/) via #151 (2026-05-26). Deferred outside spec-002: app-wide NotificationCenter + structured `ErrorClassification` ([#149](https://github.com/luca-veronelli-stem/button-panel-tester/issues/149)); vendored-stack → `Stem.Communication` migration with hot-plug regression guard ([#111](https://github.com/luca-veronelli-stem/button-panel-tester/issues/111)).
