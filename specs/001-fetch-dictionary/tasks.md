...
- [ ] T005c [Issue #76] Update `Stem.ButtonPanelTester.slnx` to register `ButtonPanelTester.Tests.Windows` alongside the existing entries. Ordering: Core → Services → Infrastructure → GUI → Tests → Tests.Windows.
