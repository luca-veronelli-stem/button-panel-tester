...
- [ ] T006 Update `tests/ButtonPanelTester.Tests/ButtonPanelTester.Tests.fsproj` — add PackageReferences `FsCheck.Xunit` + `Avalonia.Headless.XUnit`, add ProjectReferences to Services + Infrastructure + GUI (Core is already referenced).
